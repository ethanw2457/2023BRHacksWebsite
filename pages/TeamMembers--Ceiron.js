...
const TeamMembers = () => {
  ...
  const teamMember = {
    profilePicture: '/aa-pictures/Ceiron.png',
    name: 'Ceiron Dushyanthan',
    role: 'Events & Logistics Leader',

    bio: 'Rising Senior at BRHS',
    bio4: 'Ceiron Dushyanthan is a soon to be Senior at Bridgewater-Raritan High School. With an interest in computer science, he hopes to pursue research in machine learning. Additionally, he enjoys competitive sports such as track and soccer. He hopes to see all of you at the hackathon.',


    instagramLink: 'https://www.instagram.com/ceiron_d/',
    linkedinLink: 'www.linkedin.com/in/ceiron/',
  };
