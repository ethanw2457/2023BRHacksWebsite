...
const TeamMembers = () => {
  ...
  const teamMember = {
    profilePicture: '/aa-pictures/Soham.jpeg',
    name: 'Soham Chausalkar',
    role: 'Social Media Team Member',

    bio: 'Rising Junior at BRHS',
    bio4: 'Driven by a passion for STEM and Machine Learning; He is dedicated to building a strong foundation in Artificial Intelligence to pave the way for a promising future in technology',


    instagramLink: 'https://www.instagram.com/soham_chausalkar/',
    linkedinLink: 'https://www.linkedin.com/in/soham-chausalkar-185311281/',
  };
