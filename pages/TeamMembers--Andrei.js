...
const TeamMembers = () => {
  ...
  const teamMember = {
    profilePicture: '/aa-pictures/Andrei.jpeg',
    name: 'Andrei Cojocariu',
    role: 'Events & Logistics Team Member',

    bio: 'Rising Senior at BRHS',
    bio4: 'Andrei is a rising senior at Bridgewater-Raritan HS and is involved in FBLA, Forensics Speech & Debate, and the BR Engineering Team at his school. Andrei enjoys reading, listening to Spotify on repeat, and practicing martial arts in his free time. As director of Domestic Affairs, Andrei hopes to inform readers about pressing economic matters in our nation. (For EconSimple). As a Events and Logistics Team member, Andrei hopes to make the BR Hackathon experience as accessible and entertaining as possible. (For BRHacks)',
