...
const TeamMembers = () => {
  ...
  const teamMember = {
    profilePicture: '/aa-pictures/Nakul.jpeg',
    name: 'Nakul Rao',
    role: 'Outreach Team Member',

    bio: 'Rising Senior at BRHS',
    bio4: 'Hello Everyone! My name is Nakul Rao. I am part of the Outreach Team for the first annual BRHS Hackathon. Thank you!',
