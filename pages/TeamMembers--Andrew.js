...
const TeamMembers = () => {
  ...
  const teamMember = {
    profilePicture: '/aa-pictures/default.png',
    name: 'Andrew Zagula',
    role: 'Tech & Design Member',

    bio: 'Rising Sophomore at BRHS',
    bio4: 'Andrew is a sophomore (as of fall 2023) at Bridgewater-Raritan High School. As a technology and design team member at BRHS Hackathon, he is a graphic and UI/UX designer contributing to the Hackathons website. In his free time, he enjoys playing volleyball, listening to music, and spending time with friends and family.',


    instagramLink: 'https://www.instagram.com/andrewzagulaa/',
    linkedinLink: '',
  };
