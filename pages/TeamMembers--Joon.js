...
const TeamMembers = () => {
  ...
  const teamMember = {
    profilePicture: '/aa-pictures/Joon.jpeg',
    name: 'Joon Young Doh',
    role: 'Social Media Team Member',

    bio: 'Rising Junior at BRHS',
    bio4: 'Hi everyone! My name is Joon Young Doh, and Im on the outreach team for the BRHS Hackathon. I love literature, STEM, and volleyball, and I hope to work as an AI specialist. Hope to see you soon!',


    instagramLink: 'https://www.instagram.com/maybeitsjoon/',
    linkedinLink: 'https://www.linkedin.com/in/joon-doh-58b334279/',
  };
