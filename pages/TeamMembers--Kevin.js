...
const TeamMembers = () => {
  ...
  const teamMember = {
    profilePicture: '/aa-pictures/Kevin.jpeg',
    name: 'Kevin Abbaszadeh',
    role: 'Outreach Team Member',

    bio: 'Rising Junior at BRHS',
    bio4: 'Hello! My name is Kevin Abbaszadeh and I am a current Junior at Bridgewater-Raritan High School. I participate on the Varsity Track & Field team, and I enjoy going on road trips with my friends! I am part of the Outreach Team, for the BRHS Hackathon!',


    instagramLink: 'https://www.instagram.com/kevinrizi',
    linkedinLink: 'https://www.linkedin.com/in/kevin-abbaszadeh-64a133255/',
  };
